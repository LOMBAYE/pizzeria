 ...
 */
final class Version20220707181716 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE zone_livraison (zone_id INT NOT NULL, livraison_id INT NOT NULL, INDEX IDX_289ACC6A8E54FB25 (livraison_id), INDEX IDX_289ACC6A9F2C3FAB (zone_id), PRIMARY KEY(zone_id, livraison_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
