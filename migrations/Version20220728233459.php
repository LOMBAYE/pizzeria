 ...
 */
final class Version20220728233459 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE beignet (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prix INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE boisson_taille (id INT NOT NULL, complement_id INT DEFAULT NULL, taille TINYINT(1) NOT NULL, qte_en_stock INT DEFAULT NULL, INDEX IDX_E7A2EE140D9D0AA (complement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, livraison_id INT DEFAULT NULL, is_etat TINYINT(1) DEFAULT NULL, numero VARCHAR(255) DEFAULT NULL, date DATE DEFAULT NULL, expedie TINYINT(1) DEFAULT NULL, INDEX IDX_6EEAA67D19EB6921 (client_id), INDEX IDX_6EEAA67D8E54FB25 (livraison_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE livraison (id INT AUTO_INCREMENT NOT NULL, livreur_id INT DEFAULT NULL, zone_id INT DEFAULT NULL, gestionnaire_id INT DEFAULT NULL, is_etat TINYINT(1) DEFAULT NULL, INDEX IDX_A60C9F1FF8646701 (livreur_id), INDEX IDX_A60C9F1F9F2C3FAB (zone_id), INDEX IDX_A60C9F1F6885AC1B (gestionnaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE plateau (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prix INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE plateau_beignet (id INT AUTO_INCREMENT NOT NULL, beignet_id INT DEFAULT NULL, plateau_id INT DEFAULT NULL, quantite INT NOT NULL, INDEX IDX_D1729995BFA80CD5 (beignet_id), INDEX IDX_D1729995927847DB (plateau_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `produit` (id INT AUTO_INCREMENT NOT NULL, gestionnaire_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prix INT NOT NULL, image LONGBLOB NOT NULL, is_etat TINYINT(1) NOT NULL, type VARCHAR(255) NOT NULL, INDEX IDX_29A5EC276885AC1B (gestionnaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE plateau_beignet ADD CONSTRAINT FK_D1729995BFA80CD5 FOREIGN KEY (beignet_id) REFERENCES beignet (id)');
        $this->addSql('ALTER TABLE plateau_beignet ADD CONSTRAINT FK_D1729995927847DB FOREIGN KEY (plateau_id) REFERENCES plateau (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE plateau_beignet DROP FOREIGN KEY FK_D1729995BFA80CD5');
        ...
        $this->addSql('ALTER TABLE plateau_beignet DROP FOREIGN KEY FK_D1729995927847DB');
        ...
        $this->addSql('DROP TABLE beignet');
        ...
        $this->addSql('DROP TABLE plateau_beignet');
